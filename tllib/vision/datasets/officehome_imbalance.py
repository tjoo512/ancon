...
class OfficeHome_Imbalance(ImageList):
    ...
    # ]
    image_list = {
        "Ar": "image_list_imbalance/Art.txt",
        "Cl": "image_list_imbalance/Clipart.txt",
        "Pr": "image_list_imbalance/Product.txt",
        "Rw": "image_list_imbalance/Real_World.txt",
    }
    ...
    def __init__(self, root: str, task: str, download: Optional[bool] = False, **kwargs):
        ...
        super(OfficeHome_Imbalance, self).__init__(root, OfficeHome_Imbalance.CLASSES, data_list_file=data_list_file, **kwargs)
